...
src_prepare() {
	...
	epatch "${FILESDIR}"/aex/0001-server-add-alloc_sock-to-init-socket-objects
	epatch "${FILESDIR}"/aex/0002-server-change-accept_socket-to-take-a-sock
	epatch "${FILESDIR}"/aex/0003-server-move-is_removeable-to-fd_ops
	epatch "${FILESDIR}"/aex/0004-server-don-t-allow-caching-disconnected-SOCK_STREAM-so
	epatch "${FILESDIR}"/aex/0005-server-replace-reselect_async-by-async_event
	epatch "${FILESDIR}"/aex/0006-server-add-async_terminated-to-allow-server-side-reque
	epatch "${FILESDIR}"/aex/0007-server-create-register_accept_async-to-queue-async-acc
	epatch "${FILESDIR}"/aex/0008-ws2_32-implement-AcceptEx
	epatch "${FILESDIR}"/aex/0009-ws2_32-implement-GetAcceptExSockaddrs
	epatch_user #282735
